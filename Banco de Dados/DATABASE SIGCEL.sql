...
nm_rua_funcionario varchar(50) not null,-- rua
cd_numero_funcionario int not null,-- numero 
...
ic_pesquisa_feita bool not null,
...
constraint fk_alternativa_pergunta foreign key (cd_pergunta,cd_pesquisa) references pergunta (cd_pergunta,cd_pesquisa)
);
...
hr_fim_compromisso time not null,
...
cd_numero_compromisso varchar (10) not null,
ic_chama_funcionario bool,
ic_chama_militancia bool,
cd_tipo_compromisso int not null,
nm_email_compromisso text null,
...
-- insert into compromisso values ('2016-06-25','20:00','reuniao de amanha','santos','embare','rua qualquer','15',false,false,3);
